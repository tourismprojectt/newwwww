...
class _ScreenThreeState extends State<ScreenThree> {
  ...
  void toggleFavoriteStatus(int index) async {
    ...
    final place = cairoPlaces[index]; // Use alexHotels instead of cairoHotels
    ...
    setState(() {
      cairoPlaces[index].isFavorite = !cairoPlaces[index]
          ...
          for (int i = 0; i < cairoPlaces.length; i++)
            Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                buildIndicator(
                    activeIndices[i], cairoPlaces[i].imagePaths.length),
                SizedBox(height: 10),
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          _launchURL(
                              cairoPlaces[i].url); // Launch URL when tapped
                        },
                        child: Icon(
                          Icons.link,
